...
import { getElementPalette } from '@/app/utilities/color';
...
export const ColorProperty: FC = () => {
  ...
  const onChangeLineColor = useCallback(
    (color: string | GradientStop[]) => {
      if (activeLineObject) {
        activeLineObject.line.setStroke(color);
            ...
            <div className="grid gap-2 grid-cols-6">
              ...
              {palette.map(color => (
                <Button
                  ...
                  isIconOnly
                  onClick={() => onChangeLineColor(color)}
